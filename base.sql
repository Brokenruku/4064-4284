...
-- =========================================
-- INSERTION DES NUMEROS DE TELEPHONE
-- =========================================

INSERT INTO numero_telephone (prefix_id, numero, solde) VALUES
(1, '12345678', 250000),
(1, '23456789', 150000),
(1, '34567890', 500000),
(1, '45678901', 100000),
...
-- =========================================
-- INSERTION DES FRAIS DE RETRAIT
-- =========================================

INSERT INTO frais_retrait (
    montant_min,
    montant_max,
    frais
) VALUES
...
-- =========================================
-- INSERTION DES FRAIS DE TRANSFERT
-- =========================================

INSERT INTO frais_transfert (
    montant_min,
    montant_max,
    frais
) VALUES
...
(1, 5, 25000, '2026-07-10'),
(2, 8, 50000, '2026-07-11'),
(3, 10, 75000, '2026-07-11'),
(4, 7, 100000, '2026-07-12'),
(5, 12, 150000, '2026-07-12'),
(6, 14, 25000, '2026-07-13'),
(7, 16, 200000, '2026-07-13'),
